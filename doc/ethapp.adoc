...
contract address *(only for message fields)* || json key length || json key || display name length || display name

signed by the following secp256k1 public key 0482bbf2f34f367b2e5bc21847b6566f21f0976b22d3388a9a5e446ac62d25cf725b62a2555b2dd464a4da0ab2f4d506820543af1d242470b1b1a969a27578f353

Filtering is set to basic by default and has to be changed with this APDU as *set mode*.
Field informations will be ignored if the mode is set to basic.

In full mode, fields will be by default hidden unless they receive a field information.

The mode can be overriden by the in-app setting to full-clear sign EIP-712 messages.
...
|   E0  |   1E   | 00 : set mode
                   ...
                   FF : field info    | 00         | variable | variable
|=========================================================================
...
| 0x00          | Basic (internal filtering)
| 0xFF          | Full (externally provided)
|=================================
